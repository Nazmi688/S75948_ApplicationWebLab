<%-- 
    Document   : dashboard
    Created on : 19 May 2026, 3:49:31 pm
    Author     : Nazmi
--%>
        ...
        <div class="container d-flex justify-content-center align-items-center"
            ...
            <div class="card shadow-lg border-0 rounded-4 p-4 p-md-5 text-center"
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted fs-5 mb-4">Matric Number: <strong class="text-secondary"><div class="d-flex justify-content-center gap-3 flex-wrap">
